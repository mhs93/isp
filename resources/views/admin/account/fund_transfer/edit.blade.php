    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ route('admin.fund-transfer.update', $data->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="transaction_date" id="transaction_date" value="{{  $data->date }}" class="form-control datepicker @error('transaction_date') is-invalid @enderror" placeholder="Enter transaction date" required>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        onchange="getBalance()"class="form-control"  @error('from_account_id') is-invalid @enderror >
                                            <option value=""  >Select Account</option>
                                           @foreach ($accounts as $key => $item)
                                             <option value="{{ $item->id }}" @if($item->id == $data->from_account_id) selected @endif>
                                                {{ $item->name }} </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="to_account_id"> To Account <span class="text-red">*<span
                                            ...
                                            style="display: none"></span></span></label><input type="hidden" value="" id="to_amount_balance">

                                        <select name="to_account_id" id="to_account_id" onchange="TogetBalance()" class="form-control"  @error('to_account_id') is-invalid @enderror >
                                            <option value="" > Select Account</option>
                                             @foreach ($accounts as $key => $item)
                                             <option value="{{ $item->id }}" @if($item->id == $data->to_account_id) selected @endif>
                                                {{ $item->name }} </option>
                                            @endforeach
                                        </select>
                                 ...
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        onkeyup="AmountCheck()" id="amount" value="{{ $data->amount }}" class="form-control @error('amount') is-invalid @enderror" placeholder="Enter amount" required>
